...
const subcommands = [
    ...
    { name: 'cpu', typeLabel: "{underline time in seconds}", description: "will try to use 100% of one CPU for {underline seconds}. Also supports units, add h, m, s or ms to specify. Default is seconds."},
